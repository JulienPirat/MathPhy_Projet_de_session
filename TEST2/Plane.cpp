...
Plane::Plane(Vector3D pos, Vector3D vel, Vector3D rotat, float linDamp, float angDamp, float mass, Vector3D col, float x, float y) : RigidBody(pos, vel, rotat, linDamp, angDamp, mass, col, MakeInverseInertiaPlane(x,y,mass), plane, Vector3D(x,y,0))
{
	shape = plane;
